...
openssl_md_meth_names = None # (!) real value is "frozenset({'sha3_224', 'md5-sha1', 'ripemd160', 'sha1', 'blake2b', 'shake_128', 'blake2s', 'shake_256', 'sha512_224', 'md5', 'sha384', 'sha224', 'md4', 'whirlpool', 'sha3_512', 'sm3', 'sha3_384', 'sha512_256', 'mdc2', 'sha256', 'sha512', 'sha3_256'})"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000024BF285B070>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000024BF285B070>, origin='C:\\\\BuildAgent\\\\system\\\\.persistent_cache\\\\pycharm\\\\pythons4utils\\\\python310\\\\DLLs\\\\_hashlib.pyd')"

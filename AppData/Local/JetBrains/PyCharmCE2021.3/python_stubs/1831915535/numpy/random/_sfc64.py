...
class SFC64(__numpy_random_bit_generator.BitGenerator):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000013BCB65DB00>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000013BCB65DAE0>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.random._sfc64', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000013BCB65DAE0>, origin='C:\\\\Users\\\\marco\\\\PycharmProjects\\\\aulateste\\\\venv\\\\lib\\\\site-packages\\\\numpy\\\\random\\\\_sfc64.cp310-win_amd64.pyd')"
